...
{	sensorPrep();
	...
	gecko_printf("Testing bits of reset register 0x0D8005E0. Writing 0x1.\n");

	u32 i, RESETREG=0x0D8005E0, newVal = 0x1;
	write32(RESETREG, newVal);
	for(i=1; i<32; i++)
	{	gecko_printf("Testing bit 1<<%d(%08x)...", i, (newVal&=(1<<i)));
		udelay(1000000);
		write32(RESETREG, newVal);
